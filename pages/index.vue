            ...
            <div class="container mx-auto my-12">
                ...
                <div class="max-w-4xl mx-auto px-5 my-12">
                    <div class="grid md:grid-cols-2 gap-10 my-12">
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-gray-500">
                                    You don't need to be an expert to customize
                                    this plugin. Our code is very readable and
                                    well documented.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4 items-start">
                            <span
                                class="text-violet-600 bg-violet-500/10 p-3 rounded-full"
                            >
                                <svg
                                    width="15"
                                    height="15"
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-gray-500">
                                    ...
                                    This plugin is responsive in all browsers.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-gray-500">
                                    We make sure our plugins are working
                                    perfectly with all modern browsers available
                                    such as Chrome, Firefox, Safari.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-gray-500">
                                    ...
                                    with unit tests to make sure your
                        ...
                        <div class="flex gap-4 items-start">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-gray-500">
                                    ...
                                    core plugin team. We are working on fixing
                                    each of the issues reported.
                                </p>
                            </div>
                        </div>
                    </div>
